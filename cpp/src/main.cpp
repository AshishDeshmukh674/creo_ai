...
std::string get_voice_input() {
    ...
    cmd << "python \"" << exeDir << "\\..\\..\\..\\py\\voice_input\"";
...
int main(int argc, char* argv[]) {
    try {
        ...
        std::string onnx_path = "../../onnx_model/t5_creo_quantized.onnx";  // Use quantized model for faster inference
        ...
        NL2Trail model(onnx_path, spm_path, /*maxNewTokens=*/128);  // Reduced for faster generation
